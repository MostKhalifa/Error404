...
export default function NavBarInstructor() {
  ...
  const renderMobileMenu = (
    ...
    >
      <MenuItem>
        <IconButton size="large" aria-label="show 4 new mails" color="inherit"><Badge badgeContent={4} color="error"><MailIcon /></Badge></IconButton>
        <p>Messages</p>
      </MenuItem>
      <MenuItem>
        <IconButton
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static">
        ...
        <Typography variant="h6" noWrap component="div"sx={{ display: { xs: 'none', sm: 'block' } }}>
            <a href="https://i.imgur.com/fe0T4nw.png"><img src={logo} onClick="https://google.com" /></a>
            </Typography>
