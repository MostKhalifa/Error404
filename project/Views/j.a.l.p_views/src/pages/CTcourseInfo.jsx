...
useEffect(()=>{
 axios.get("/trainee/CorporateTrainee/viewCourseInfo/639146aede71ce0ca5a1a09d?id1=639114e227ba150662d88096").then(
    function (response) {
         ...
         <TableBody>
           {courseInfo.data.reviews.map((row) => (
             ...
             >
               ...
               <TableCell align="right">{row.instructorNotes}</TableCell>
               <TableCell align="right">{row.totalHours}</TableCell>
               <TableCell align="right">{row.exercise}</TableCell>
               <TableCell align="right">{row.chapterAssesment}</TableCell>
             </TableRow>
           ))}
         </TableBody>
       </Table>
